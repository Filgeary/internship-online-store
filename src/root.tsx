const Root = ({ app, head }: { app: JSX.Element; head: JSX.Element }) => {
  return (
    <html lang='en'>
      <head>
        <meta charSet='UTF-8' />
