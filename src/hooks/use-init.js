...
/**
 * Хук для асинхронных расчётов, которые будут исполнены при первом рендере,
 * изменении search-параметров браузера (если backForward=true) или изменении depends
