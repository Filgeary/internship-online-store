...
import { TCategoriesConfig, TCategoriesState, TCategory } from './types';

/**
 * Список категорий
 */
class CategoriesState extends StoreModule<TCategoriesState, TCategoriesConfig> {
  readonly config: TCategoriesConfig;
