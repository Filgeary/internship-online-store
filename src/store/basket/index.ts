...
import { TBasketActive, TBasketArticle, TBasketConfig, TBasketState } from './types';

/**
 * Покупательская корзина
 */
class BasketState extends StoreModule<TBasketState, TBasketConfig> {
  readonly config: TBasketConfig;
